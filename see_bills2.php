        ...
        <tr>
          ...
          <?php
            ...
            else
            {
              ...
              $sql = "Select * from coustomer_details where coustomer_name= '".$_POST['selected_name']."';";
              $result = mysqli_query($conn, $sql);
              while($row = mysqli_fetch_assoc($result))
              {
                echo "<tr>";
            ...
            else
            {
              ...
              $sql = "Select * from coustomer_details where coustomer_contact_no= '".$_POST['selected_contact']."';";
              $result = mysqli_query($conn, $sql);
              while($row = mysqli_fetch_assoc($result))
              {
                echo "<tr>";
