<?php
   ...
   $sql = "update items set quantity = ".$_POST['itquantity']." where Item_name = '".$_POST['itname']."';";
...
<body>
  ...
  <div class="container">
    <form action="insertgoods2.php" method="post">
        <div id="Main-container">
           ...
           <div style="margin-top:10px;">
                <span>
                         <label for="itquatity">Enter quantity</label>
                         <input type="text" name="itquantity">
                </span>
           </div>
           <button type="Submit" style="margin-top:10px;">Insert Goods</button>
        </div>
    </form>
  </div>
