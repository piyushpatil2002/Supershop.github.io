...
<div class="container">
  <div id="Main-container" style="font-size:20px;">
    <form action="insert_items2.php" method="post">
            <div>
                <span id="Bill-Name">
                    <label for="bi">enter Item Name </label>

                    <input type="text" id="name" placeholder="Enter item name" name="item_name">
                    <span><button type="Submit">Add item</button></span>
                </span>
                <?php
                ...
                $sql = "insert into `items` (`Item_name`, `quantity`) VALUES ('".$_POST['item_name']."', '0');";
